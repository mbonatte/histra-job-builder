...
class PierSpec(BaseModel):
    ...
    foundation_length: float = Field(default=80.0, gt=15.0, description="Foundation longitudinal size (Bf) in cm")
    ...
    material_key: int = Field(default=22, description="Material template key for pier shaft")
...
class AbutmentSpec(BaseModel):
    ...
    height: float = Field(default=150.0, gt=20.0, description="Abutment wall height in cm")
    thickness: float = Field(default=70.0, gt=20.0, description="Abutment longitudinal thickness in cm")
    foundation_height: float = Field(default=60.0, gt=15.0, description="Abutment foundation depth in cm")
